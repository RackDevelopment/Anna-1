package optic_fusion1.anna.util.encoding;
...
public class Base32Encoding {
  ...
  /**
   * This array is a lookup table that translates 5-bit positive integer index values into their "Base32 Alphabet" equivalents as specified in Table 3 of RFC 2045.
   */
  ...
  /**
   * Convenience variable to help us determine when our buffer is going to run out of room and needs resizing. <code>decodeSize = {@link #BYTES_PER_ENCODED_BLOCK} - 1 + lineSeparator.length;</code>
   */
  private final int decodeSize;
  /**
   * Convenience variable to help us determine when our buffer is going to run out of room and needs resizing. <code>encodeSize = {@link #BYTES_PER_ENCODED_BLOCK} + lineSeparator.length;</code>
   */
   ...
   * </p>
   */
  public Base32Encoding(boolean usePaddingCharacter) {
